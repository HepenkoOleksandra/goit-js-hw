...
// console.log();//з випадковими, але валідними аргументами, повертає правильне значення
...
// }
// const arr = [1, 2, 3, 4, 5];
// const getArray = changeEven(arr, 10);
...
// console.log(getUserEmails(sumUser));
...
// const result = colorPickerOptions.find((option) => option.label === "blue"); // { label: "blue", color: "#2196F3" }
// console.log(result);
// const result1 = colorPickerOptions.find((option) => option.label === "pink"); // { label: "pink", color: "#E91E63" }
// console.log(result1);
// const result2 = colorPickerOptions.find((option) => option.label === "white"); // undefined
// console.log(result2);
...
// console.log(isEveryUserActive(everyUsers));
...
// const totalPlayTime = playtimes.reduce((sumTime, player) => {
//   return sumTime + player;
// }, 0);
...
// const calculateTotalBalance = allUsers.reduce((total, user) => {
...
// const scores = [61, 6, 19, 74, 3, 35, 92, 56];
...
// const scores = [61, 19, 74, 5, 35, 92, 56];
...
// const onAlphabeticalOrder = students.toSorted((firstStudent, secondStudent) =>
//   secondStudent.name.localeCompare(firstStudent.name)
// );
// console.log(onAlphabeticalOrder);
...
//   .map((book, index, array) => book.author )
